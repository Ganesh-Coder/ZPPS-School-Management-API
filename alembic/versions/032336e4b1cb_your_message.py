...
Revision ID: 032336e4b1cb
Revises: 85cf10c882a3
Create Date: 2026-06-09 22:20:28.173287
...
def upgrade():
    ...
    op.drop_index('recipes_category_name_948247a5_like', table_name='recipes_category')
    op.drop_table('recipes_category')
    op.drop_index('auth_permission_content_type_id_2f476e4b', table_name='auth_permission')
    op.drop_table('auth_permission')
    op.drop_index('recipes_recipe_category_id_6d665355', table_name='recipes_recipe')
    op.drop_table('recipes_recipe')
    op.drop_index('auth_user_username_6821ab7c_like', table_name='auth_user')
    op.drop_table('auth_user')
    op.drop_index('recipes_chef_category_id_7968fa64', table_name='recipes_chef')
    op.drop_table('recipes_chef')
...
def downgrade():
    ...
    sa.Column('prep_time', sa.INTEGER(), autoincrement=False, nullable=False),
    ...
    sa.ForeignKeyConstraint(['category_id'], ['recipes_category.id'], name='recipes_chef_category_id_7968fa64_fk_recipes_category_id', initially='DEFERRED', deferrable=True),
    sa.PrimaryKeyConstraint('id', name='recipes_chef_pkey')
    )
    op.create_index('recipes_chef_category_id_7968fa64', 'recipes_chef', ['category_id'], unique=False)
    ...
    op.create_table('recipes_recipe',
    sa.Column('id', sa.BIGINT(), sa.Identity(always=False, start=1, increment=1, minvalue=1, maxvalue=9223372036854775807, cycle=False, cache=1), autoincrement=True, nullable=False),
    sa.Column('title', sa.VARCHAR(length=200), autoincrement=False, nullable=False),
    sa.Column('description', sa.TEXT(), autoincrement=False, nullable=False),
    sa.Column('ingredients', sa.TEXT(), autoincrement=False, nullable=False),
    ...
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=False),
    sa.Column('category_id', sa.BIGINT(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['category_id'], ['recipes_category.id'], name='recipes_recipe_category_id_6d665355_fk_recipes_category_id', initially='DEFERRED', deferrable=True),
    sa.PrimaryKeyConstraint('id', name='recipes_recipe_pkey')
    )
    op.create_index('recipes_recipe_category_id_6d665355', 'recipes_recipe', ['category_id'], unique=False)
    ...
    op.create_table('recipes_category',
    sa.Column('id', sa.BIGINT(), sa.Identity(always=False, start=1, increment=1, minvalue=1, maxvalue=9223372036854775807, cycle=False, cache=1), autoincrement=True, nullable=False),
    sa.Column('name', sa.VARCHAR(length=100), autoincrement=False, nullable=False),
    sa.Column('description', sa.TEXT(), autoincrement=False, nullable=True),
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=False),
    sa.PrimaryKeyConstraint('id', name='recipes_category_pkey'),
    sa.UniqueConstraint('name', name='recipes_category_name_key')
    )
    op.create_index('recipes_category_name_948247a5_like', 'recipes_category', ['name'], unique=False)
